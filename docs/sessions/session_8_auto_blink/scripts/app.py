...
class MainWindow(QMainWindow):
    ...
    def create_expressions_tab(self):
        ...
        # Auto-blink control
        blink_group = QGroupBox("Clignement Automatique")
        ...
        # Info label
        info_label = QLabel("L'avatar clignera des yeux toutes les 2-5 secondes de manière aléatoire.")
        info_label.setStyleSheet("font-size: 11px; color: gray; font-style: italic;")
        info_label.setWordWrap(True)
        blink_layout.addWidget(info_label)
